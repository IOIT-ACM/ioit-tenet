...
export const GCCarousel: React.FC = () => {
  ...
  return (
    <div
      id='timeline'
      ref={carouselRef}
      className='carousel flex h-fit min-h-screen w-full cursor-grab select-none items-center justify-center'
      style={{
    ...
    >
      {imageData.map((image, index) => (
        <div
          key={index}
          className={`carousel-image absolute flex h-[200px] w-[200px] items-center justify-center text-white md:h-[300px] md:w-[400px] ${
