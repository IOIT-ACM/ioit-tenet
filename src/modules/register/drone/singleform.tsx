...
export default function SingleDroneRegisterForm() {
  // Image upload
  ...
  async function onSubmit(values: DRONEUser) {
    ...
    if (!form.formState.isValid) {
      ...
      try {
        const response = await fetch('/api/register/drone/single', {
          method: 'POST',
          headers: {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      <h2 className='mb-5 text-center text-2xl font-semibold text-gray-300'>
        Register for one person
      </h2>
      ...
      <Form {...form}>
        ...
        >
          ...
          <Button
            ...
            type='button'
            onClick={() => {
              onSubmit(form.getValues() as DRONEUser);
            }}
