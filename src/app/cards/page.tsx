      ...
      <ul className="mx-auto w-full max-w-2xl gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="flex cursor-pointer flex-col items-center justify-between rounded-xl p-4 hover:bg-neutral-500 hover:text-white md:flex-row"
          >
            ...
            <motion.button
              ...
              className="mt-4 rounded-full bg-gray-100 px-4 py-2 text-sm font-bold text-black hover:bg-red-500 hover:text-white md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
